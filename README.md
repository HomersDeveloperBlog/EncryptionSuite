# EncryptionSuite
An implementation of the popular public key encryption scheme, RSA (and more!), gratuitously applied as a block cipher for file encryption. Obviously, as far as practical cryptography goes, there is not reason to ever encrypt a file using an asymmetric cryptosystem. Nonetheless, this was the simplest way I could demonstrate the code.
...
- Rhobustness against portability issues, exceptions, invalid user input. This includes strict standards conformance. 
- Good performance.
